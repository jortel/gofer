...
with ipatch('amqp'):
    ...
    from gofer.messaging.adapter.amqp.broker import Broker, BaseBroker, SocketError
...
class TestBroker(TestCase):
    ...
    @patch('gofer.messaging.adapter.amqp.broker.Broker.open')
    ...
    @patch('gofer.messaging.adapter.amqp.broker.Broker._ssl')
    @patch('gofer.messaging.adapter.amqp.broker.Connection')
    def test_open(self, connection, _ssl):
        url = 'amqp+amqp://elmer:fudd@redhat.com:1234/test-virtual-host'
    ...
    @patch('gofer.messaging.adapter.amqp.broker.sleep')
    @patch('gofer.messaging.adapter.amqp.broker.Connection')
