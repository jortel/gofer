...
class TestReader(TestCase):
    ...
    @patch('gofer.messaging.adapter.amqp.consumer.Ack')
    @patch('gofer.messaging.adapter.amqp.consumer.model')
    @patch('gofer.messaging.adapter.amqp.consumer.auth')
    @patch('gofer.messaging.adapter.amqp.consumer.Endpoint', Mock())
    ...
    @patch('gofer.messaging.adapter.amqp.consumer.model.validate')
    @patch('gofer.messaging.adapter.amqp.consumer.auth')
    @patch('gofer.messaging.adapter.amqp.consumer.Endpoint', Mock())
