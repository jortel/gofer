...
class TestDecorators(TestCase):
    ...
    @patch('gofer.messaging.adapter.amqp.endpoint.Broker')
...
class TestEndpoint(TestCase):
    ...
    @patch('gofer.messaging.adapter.amqp.endpoint.RLock')
    ...
    @patch('gofer.messaging.adapter.amqp.endpoint.Broker')
    @patch('gofer.messaging.adapter.amqp.endpoint.RLock', Mock())
