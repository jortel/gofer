...
with ipatch('amqplib'):
    from gofer.messaging.adapter.amqplib.consumer import Receiver, Inbox, Empty
...
class TestReader(TestCase):
    ...
    @patch('gofer.messaging.adapter.amqplib.consumer.Endpoint', Mock())
    @patch('gofer.messaging.adapter.amqplib.consumer.Receiver')
    @patch('gofer.messaging.adapter.amqplib.consumer.BaseReader.open')
    ...
    @patch('gofer.messaging.adapter.amqplib.consumer.Empty', Empty)
    ...
    @patch('gofer.messaging.adapter.amqplib.consumer.Endpoint', Mock())
    @patch('gofer.messaging.adapter.amqplib.consumer.BaseReader.close')
...
class TestReceiver(TestCase):
    ...
    def test_fetch(self):
        ...
        # validation
        fd = channel.connection.transport.sock.fileno.return_value
