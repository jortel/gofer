...
with ipatch('amqplib'):
    ...
    from gofer.messaging.adapter.amqplib.connection import Connection, BaseConnection
    from gofer.messaging.adapter.amqplib.connection import CONNECTION_EXCEPTIONS
...
class TestConnection(TestCase):
    ...
    @patch('gofer.messaging.adapter.amqplib.connection.sleep')
    @patch('gofer.messaging.adapter.amqplib.connection.RealConnection')
