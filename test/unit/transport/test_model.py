...
from gofer.transport.model import Node
from gofer.transport.model import BaseExchange, Exchange
from gofer.transport.model import BaseQueue, Queue
from gofer.transport.model import BaseEndpoint
from gofer.transport.model import BaseReader, Reader
from gofer.transport.model import BaseProducer, Producer
from gofer.transport.model import BasePlainProducer, PlainProducer
from gofer.transport.model import BaseBroker, BrokerSingleton, Broker
from gofer.transport.model import Ack
...
class TestExchange(TestCase):
    ...
    @patch('gofer.transport.model.Transport.find')
...
class TestBaseEndpoint(TestCase):
    ...
    @patch('gofer.transport.model.uuid4')
    ...
    @patch('gofer.transport.model.BaseEndpoint.endpoint')
